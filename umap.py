...
From: https://doi.org/10.1039/D4DD00262H
...
def plot_umap_data(data: pd.DataFrame, elements: list[str], color_list: list[str],
    ...
    plt.figure(figsize = (9, 9)); plt.axis('off')
    ...
    for index, element in enumerate(elements):
        x_coordinate = data.loc[data[element] >= 0.3, 'umap_x_coordinate']
        y_coordinate = data.loc[data[element] >= 0.3, 'umap_y_coordinate']
    ...
    if save_image:
        ...
        plt.savefig('UMAP_OUT.png', dpi=96, bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    plot_umap_data(data_with_dra, elements, color_list, umap_params, time_taken,
                    graph_title, file_name+'1', save_image)
